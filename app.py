...
@sitemapper.include() # Include the route in the sitemap
@app.route('/topd', methods=["GET", "POST"])
def topd():   
    return render_template('topd.html')

@sitemapper.include() # Include the route in the sitemap
@app.route('/trendingd', methods=["GET", "POST"])
def trending():   
    return render_template('trendingd.html')

@sitemapper.include() # Include the route in the sitemap
@app.route('/foodd', methods=["GET", "POST"])
def foodd():   
